...
impl MiningRewardSystem {
    ...
    pub fn new() -> Self {
        Self {
            initial_reward: 6_250_000_000, // 6.25 FVC in wei (9 decimals)
            ...
            total_minable_supply: 2_340_585_000_000_000u128, // 2.34B FVC (65% of total supply, 9 decimals)
        }
    }
...
pub mod utils {
    ...
    /// Convert wei to FVC (divide by 10^9)
    pub fn wei_to_fvc(wei: u128) -> f64 {
        wei as f64 / 1_000_000_000.0
    }
    
    /// Convert FVC to wei (multiply by 10^9)
    pub fn fvc_to_wei(fvc: f64) -> u128 {
        (fvc * 1_000_000_000.0) as u128
    }
...
mod tests {
    ...
    fn test_initial_reward() {
        ...
        assert_eq!(reward.ecosystem_reward, 625_000_000); // 0.625 FVC (10%)
        assert_eq!(reward.miner_reward, 5_625_000_000); // 5.625 FVC (90%)
    }
    ...
    fn test_first_halving() {
        ...
        assert_eq!(reward.total_reward, 3_125_000_000); // 3.125 FVC (9 decimals)
    ...
    fn test_max_supply_calculation() {
        ...
        // Should be approximately 3.583 billion FVC (3,583,900,000 * 10^9 wei)
        assert!(max_supply > 3_583_000_000_000_000_000);
        assert!(max_supply < 3_584_000_000_000_000_000);
    }
}