# Deploy FVC Dashboard to Cloud Server
$ServerIP = "103.245.38.44"
$Username = "root"
$Password = "a6?#PMWdik52"

Write-Host "Deploying FVC Dashboard to Cloud Server..." -ForegroundColor Green
...
Write-Host "[INFO] Uploading dashboard files..." -ForegroundColor Cyan
echo y | pscp -pw $Password -r dashboard/* $Username@${ServerIP}:/opt/fvc-dashboard/

# Install dashboard dependencies and build
Write-Host "[INFO] Installing dependencies and building dashboard..." -ForegroundColor Cyan
